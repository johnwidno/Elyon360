...
import {
    ...
    Camera, Award, PlusCircle, ShieldAlert, Maximize, AlertCircle, Lock, TrendingUp, Save, MoreHorizontal, Share2, Smartphone
} from 'lucide-react';
...
export default function MemberHome() {
    ...
    // Show button if (Browser supports prompt OR it is iOS) AND not already installed
    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full border-r relative overflow-hidden" style={{ background: SIDEBAR_BG, borderColor: SIDEBAR_BORDER }}>
            ...
            {/* Removed conditional PWA button from bottom */}
