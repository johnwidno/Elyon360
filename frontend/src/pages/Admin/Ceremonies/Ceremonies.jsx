                            ...
                            ceremonies.map((c) => (
                                <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-all group animate-slide-up">
                                    ...
                                    <td className="px-10 py-6 whitespace-nowrap">
                                        <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/10 text-indigo-600 dark:text-indigo-400 rounded-lg text-[10px] font-bold border border-indigo-100 dark:border-white/5 uppercase tracking-widest leading-none">
                        ...
                        <div className="bg-white dark:bg-[#1A1A1A] rounded-3xl overflow-hidden shadow-2xl transform transition-all sm:max-w-xl w-full z-10 border border-gray-100 dark:border-white/10 transition-colors">
                            <form onSubmit={handleSubmit} className="p-10">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input type="text" name="title" placeholder={t('ceremony_title_placeholder')} required onChange={handleChange} value={formData.title}
                                            className="w-full bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/10 rounded-xl px-5 py-3.5 text-sm text-gray-700 dark:text-white outline-none focus:border-indigo-500/30 transition-all shadow-sm" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="date" required onChange={handleChange} value={formData.date}
                                                className="w-full bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/10 rounded-xl px-5 py-3.5 text-sm font-semibold text-gray-700 dark:text-white outline-none focus:border-indigo-500/30 transition-all shadow-sm [color-scheme:light]" />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <textarea name="description" placeholder={t('ceremony_desc_placeholder')} rows="4" onChange={handleChange} value={formData.description}
                                            className="w-full bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/10 rounded-xl px-5 py-3.5 text-sm text-gray-700 dark:text-white outline-none focus:border-indigo-500/30 transition-all shadow-sm resize-none"></textarea>
                                    </div>
                                </div>
                                <div className="mt-10 flex justify-end gap-3">
                                    ...
                                    <button type="submit" className="px-10 py-3 bg-indigo-600 text-white rounded-xl text-[12px] font-bold hover:bg-indigo-700 transition-all shadow-lg active:scale-95 outline-none">
                                        {t('register')}
                                    </button>
                                </div>
                            </form>
