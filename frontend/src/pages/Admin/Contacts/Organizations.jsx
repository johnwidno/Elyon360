            ...
            <div className="space-y-8 pb-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white dark:bg-[#1A1A1A] p-8 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-premium animate-fade-in transition-all">
                    <div className="flex items-center gap-6">
                        <div className="bg-brand-primary/5 dark:bg-brand-primary/20 p-5 rounded-2xl transition-all border border-brand-primary/10 dark:border-white/5 group-hover:scale-105">
                        ...
                        <table className="w-full text-left border-separate border-spacing-0">
                            ...
                            <tbody className="divide-y divide-gray-50 dark:divide-gray-800 transition-colors">
                                {loading ? (
                                     ...
                                     orgs.map((o, index) => (
                                         <tr key={o.id}
                                             className="hover:bg-brand-primary/5 dark:hover:bg-brand-primary/10 transition-all group animate-slide-up cursor-pointer"
                                             ...
                                             <td className="px-10 py-6">
                                                 <span className={`px-4 py-1.5 rounded-xl text-[9px] font-black tracking-widest ${o.isSystem ? 'bg-brand-primary/10 dark:bg-brand-primary/30 text-brand-primary dark:text-brand-orange border border-brand-primary/20 dark:border-white/5' : 'bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-transparent'}`}>
                                                     {o.subtype?.name || o.type || 'N/A'}
                                                 </span>
                                             </td>
                                             <td className="px-10 py-6">
                                             ...
                                             <td className="px-10 py-6 text-right" onClick={e => e.stopPropagation()}>
                                                 <div className="flex justify-end gap-2 transition-colors">
                                                     <Link to={`/admin/organizations/${o.id}`} className="text-gray-400 hover:text-brand-primary transition-all p-3 bg-gray-50 dark:bg-black border border-transparent hover:border-brand-primary/20 dark:hover:border-white/5 rounded-xl hover:scale-110 active:scale-95 shadow-stripe" title={t('view')}>
                                                         <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                     ...
                                                     {!o.isSystem && (
                                                         <button onClick={() => handleEdit(o)} className="text-gray-400 hover:text-brand-orange transition-all p-3 bg-gray-50 dark:bg-black border border-transparent hover:border-brand-orange/20 dark:hover:border-white/5 rounded-xl hover:scale-110 active:scale-95 shadow-stripe" title={t('edit')}>
                                                             <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="relative bg-white dark:bg-[#1A1A1A] rounded-[2.5rem] shadow-premium-hover w-full max-w-2xl flex flex-col max-h-[95vh] overflow-hidden border border-gray-100 dark:border-white/5 animate-scale-in transition-all">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                                    <div className="md:col-span-2 space-y-3">
                                        ...
                                        <input type="text" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })}
                                            className="w-full px-6 py-4 bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/5 rounded-2xl text-[14px] font-bold text-gray-900 dark:text-white outline-none focus:ring-4 focus:ring-brand-primary/5 focus:border-brand-primary transition-all placeholder-gray-400/50 shadow-stripe"
                                    ...
                                    <div className="md:col-span-2 space-y-3">
                                        ...
                                        <textarea value={formData.description} onChange={e => setFormData({ ...formData, description: e.target.value })}
                                            className="w-full px-6 py-4 bg-gray-50 dark:bg-black border border-gray-100 dark:border-white/5 rounded-2xl text-[14px] font-bold text-gray-900 dark:text-white outline-none focus:ring-4 focus:ring-brand-primary/5 focus:border-brand-primary transition-all min-h-[120px] resize-none noscrollbar placeholder-gray-400/50 shadow-stripe"
                            ...
                            <div className="p-10 bg-gray-50 dark:bg-black/50 flex justify-end gap-4 shrink-0 transition-all border-t border-gray-100 dark:border-white/5">
                                ...
                                <button type="submit" className="px-10 py-4 bg-brand-primary text-white font-black text-[11px] tracking-widest rounded-2xl hover:bg-brand-deep shadow-premium active:scale-95 transition-all">
